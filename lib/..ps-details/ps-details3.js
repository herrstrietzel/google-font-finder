    ...
    for (let i = 0; i < detailsWraps.length; i++) {
        ...
        details.forEach((detail) => {
            ...
            */
            ...
            let textnodes = getTextNodesInEL(detail);
            console.log(children, textnodes);
            ...
            */
            ...
            // round background
            if (round || targetEl.classList.contains('details-round') || details.classList.contains('details-round') || summary.classList.contains('summary-round')) {
                classModifiers = ' summary-marker-round';
            }

            // plus/minus style
            if (icon == '+' || targetEl.classList.contains('details-plus') || details.classList.contains('details-plus') || summary.classList.contains('summary-plus')) {
                markerIconCustom = '';
                summarMarkerStyle = 'summary-marker-plus';
            }

            // right or left alignment
            if (right || targetEl.classList.contains('details-right') || details.classList.contains('details-right') || summary.classList.contains('summary-right')) {
