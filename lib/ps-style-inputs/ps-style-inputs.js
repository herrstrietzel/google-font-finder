...
const mutationObserverInputs = new MutationObserver(styleForm);
mutationObserverInputs.observe(mutationEl, mutationOptions);


//styleForm()


let svgAssetMarkup = `<svg id="svgAssetsForm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 100" style="position:absolute;width:0; height:0;" aria-hidden="true">
      <defs>
      ...
      M88.59 30.7l-38.59 38.59l-38.59-38.59" style="stroke: var(--stroke); fill: none; stroke-width: calc(var(--stroke-width) * 1.25); transform:rotate(var(--rotate)); transform-origin:center; transition: 0.3s transform;"></path>
    </symbol>
    <symbol id="radio" viewBox="0 0 95 100" overflow="visible">
      <circle cx="50%" cy="50%" r="42" style="stroke: var(--stroke); fill: var(--fill); stroke-width: var(--stroke-width);"></circle>
      <line x1="50%" x2="50%" y1="50%" y2="50%" pathLength="100" style="stroke: var(--stroke); stroke-width: var(--stroke-width-scale); stroke-dasharray:0 100; transition: 0.1s stroke-width;" stroke-linecap="round"></line>
    </symbol>
  
    <symbol id="checkbox" viewBox="0 0 90 100" overflow="visible">
      <rect x="5" y="10" width="80" height="80" style="stroke: var(--stroke); stroke-width: var(--stroke-width); fill: var(--fill);"></rect>
      <path id="checkstrokeBG" d="M 20 40 l25 20 l65 -55" pathLength="100" style="stroke:var(--strokeBG); stroke-width: 25px; fill:none; stroke-dasharray: var(--strokeDash) 100;  transition: 0.3s stroke-dasharray;"></path>
      <path id="checkstroke" d="M 20 40 l25 20 l60 -50" style="stroke: var(--stroke2); stroke-width: var(--stroke-width); fill:none; stroke-dasharray: var(--strokeDash) 100;  transition: 0.3s stroke-dasharray; stroke-dashoffset:0px;"></path>
    </symbol>
    <symbol id="checkbox__slider" viewBox="0 0 160 100" overflow="visible">
      <rect x="5" y="10" width="150" height="80" rx="40" ry="40" style="stroke: var(--stroke); stroke-width: var(--stroke-width); fill:currentColor;"></rect>
      <circle cx="45" cy="50" r="40" style="transform: translate(var(--translateX), 0); stroke: var(--stroke); fill: var(--fill); stroke-width: var(--stroke-width); transition:0.3s transform;"></circle>
    </symbol>

    <symbol viewBox="0 0 56.3 117.5" id="icon__file" fill="currentColor">
        <path d="M57.3 50.3l-23.4-23.4l-32.9 0l0 75.9l56.3 0zm-9 43.5l-38.3 0l0-57.8l19.1 0l0 19l19.2 0z"></path>
    </symbol>
    <symbol viewBox="0 0 68.2 117.5" id="icon__copy" fill="currentColor">
        <path d="M69.2 54.2l-21.1-21.1l-29.6 0l0 64.3l50.7 0l0-43.2zm-8.1 35.1l-34.5 0l0-48l17.2 0l0 17.1l17.3 0l0 30.9zm-9.2 25.3l-50.9 0l0-63.9l8.1 0l0 55.8l42.8 0l0 8.1z"></path>
    </symbol>
  </svg>`

// add sprite
  let svgAsset = document.getElementById('svgAssetsForm')
  if(!svgAsset){
    document.body.insertAdjacentHTML('beforeend', svgAssetMarkup)
  }
